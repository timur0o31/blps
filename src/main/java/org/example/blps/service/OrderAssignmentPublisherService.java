...
import org.example.blps.xmp.XmppOrderAssignmentSenderService;
...
public class OrderAssignmentPublisherService {
    ...
    private final XmppOrderAssignmentSenderService xmppSenderService;
    private final ObjectMapper objectMapper;
    private final String transport;

    public OrderAssignmentPublisherService(OrderProducerService orderProducerService, XmppOrderAssignmentSenderService xmppSenderService,
                                           ObjectMapper objectMapper, @Value("${app.assignment.transport:jms}") String transport) {
        this.orderProducerService = orderProducerService;
        this.xmppSenderService = xmppSenderService;
    ...
    private void publish(JmsMessageDto messageDto) {
        ...
        if ("xmpp".equalsIgnoreCase(transport)) {
            xmppSenderService.send(payload);
            return;
        }
