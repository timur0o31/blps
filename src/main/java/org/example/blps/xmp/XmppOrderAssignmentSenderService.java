...
@Service
public class XmppOrderAssignmentSenderService {
    ...
    public XmppOrderAssignmentSenderService(@Value("${app.xmpp.host:localhost}") String host,
                                            @Value("${app.xmpp.port:5222}") int port,
                                            @Value("${app.xmpp.domain:localhost}") String domain,
                                            @Value("${app.xmpp.sender.username:blps-sender}") String username,
                                            @Value("${app.xmpp.sender.password:blps-sender}") String password,
                                            @Value("${app.xmpp.gateway.jid:blps-gateway@localhost}") String gatewayJid) {
        this.host = host;
        this.port = port;
        this.domain = domain;
